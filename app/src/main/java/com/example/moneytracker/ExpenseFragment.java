 ...
 */
public
class ExpenseFragment extends Fragment {
    ...
    public static
    ExpenseFragment newInstance(String param1, String param2) {
    ...
    View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expenseSumResult=(TextView) myview.findViewById(R.id.expense_text_result);
